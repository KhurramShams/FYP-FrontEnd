...
/** DELETE /data-msg/conversations-delete/{conversations_id} */
export async function deleteConversation(conversationId: string): Promise<void> {
  await api.delete(`/data-msg/conversations-delete/${conversationId}`);
}

/** DELETE /data-msg/conversations-delete-all/{workspace_name} */
export async function deleteAllConversations(workspaceName: string): Promise<void> {
  await api.delete(`/data-msg/conversations-delete-all/${workspaceName}`);
}
