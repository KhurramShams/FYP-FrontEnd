    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          <Link href="/app/files" style={{ textDecoration: 'none' }}>
      ...
      {/* Charts row */}
      {analyticsLevel === 'No' ? (
        <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px dashed rgba(255,255,255,0.1)', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', padding: '48px 24px', textAlign: 'center' }}>
          <span style={{ fontSize: '28px' }}>🔒</span>
          <h3 style={{ fontSize: '16px', fontWeight: 600, color: '#fff', margin: 0 }}>Analytics Feature Locked</h3>
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', maxWidth: '360px', margin: 0, lineHeight: 1.5 }}>
            Upgrade your plan to unlock interactive query logs, token consumption histories, and workspace analysis graphs.
          </p>
          <Link href="/app/subscriptions" style={{ padding: '8px 18px', background: '#7c6df0', borderRadius: '8px', color: '#fff', fontSize: '13px', textDecoration: 'none', fontWeight: 500, marginTop: '8px' }}>
            Upgrade Plan
          </Link>
        </div>
      ) : (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
          <Section title="Query & Token Volume — 7 Days">
            {analyticsLevel === 'Basic' ? (
              <div style={{ height: '220px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', background: 'rgba(255,255,255,0.01)', border: '1px dashed rgba(255,255,255,0.08)', borderRadius: '10px', textAlign: 'center', padding: '20px' }}>
                <span style={{ fontSize: '14px', fontWeight: 600, color: '#fff' }}>Advanced Analytics Locked</span>
                <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)', margin: 0, maxWidth: '280px', lineHeight: 1.4 }}>Historical token trend analysis is available under Enterprise subscription tiers.</p>
                <Link href="/app/subscriptions" style={{ fontSize: '12px', color: '#a89ff5', textDecoration: 'none', fontWeight: 500 }}>Upgrade Plan &rarr;</Link>
              </div>
            ) : (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <Section title="Token Usage">
            {analyticsLevel === 'Advanced' ? (
              ...
              <div style={{ height: '210px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '8px', color: 'rgba(255,255,255,0.25)', fontSize: '13px', textAlign: 'center', padding: '16px' }}>
                <span>🔒 Locked</span>
                <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.3)' }}>Advanced analytics required for interactive charts.</span>
              </div>
            )}
          </Section>
