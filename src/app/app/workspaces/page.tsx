        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', background: 'rgba(124, 109, 240, 0.03)', border: `1px solid rgba(124, 109, 240, 0.15)`, borderRadius: '24px', padding: '32px' }}>
          ...
          {analyticsLevel === 'No' ? (
             <div style={{ textAlign: 'center', padding: '40px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                ...
                <span style={{ fontSize: '15px', color: '#fff', fontWeight: 600 }}>Workspace Analytics Locked</span>
                <p style={{ fontSize: '13px', color: THEME.textMuted, maxWidth: '340px', margin: 0, lineHeight: 1.4 }}>Upgrade your subscription plan to unlock detailed query trackers and workspace statistics.</p>
                <a href="/app/subscriptions" style={{ padding: '8px 16px', background: THEME.primary, border: 'none', borderRadius: '8px', color: '#fff', fontSize: '12px', fontWeight: 500, textDecoration: 'none', marginTop: '4px' }}>Upgrade Plan</a>
             </div>
          ) : !usage && !loadingUsage ? (
            ...
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '16px', marginTop: '8px' }}>
                <Section title="Recent API Request Volume (Mock Trend)">
                  {loadingUsage ? <Skeleton h="180px"/> : analyticsLevel === 'Basic' ? (
                    <div style={{ height: '220px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '8px', border: '1px dashed rgba(255,255,255,0.06)', borderRadius: '10px', padding: '16px', textAlign: 'center' }}>
                       <span style={{ fontSize: '13px', color: '#fff', fontWeight: 600 }}>Line Chart Locked</span>
                       <p style={{ fontSize: '11px', color: THEME.textMuted, margin: 0, maxWidth: '240px' }}>Historical request trends are premium insights. Upgrade to Advanced to unlock.</p>
                       <a href="/app/subscriptions" style={{ fontSize: '11px', color: THEME.secondary, textDecoration: 'none', fontWeight: 500 }}>Upgrade Plan &rarr;</a>
                    </div>
                  ) : (
                  ...
                  {loadingUsage ? <Skeleton h="180px"/> : (
                    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                       ...
                       {analyticsLevel === 'Advanced' ? (
                          ...
                          <div style={{ height: '130px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '6px', border: '1px dashed rgba(255,255,255,0.06)', borderRadius: '10px', marginBottom: '16px', color: THEME.textMuted, fontSize: '12px' }}>
                             <span>🔒 Token Chart Locked</span>
                          </div>
                       )}
      ...
      {showCreate && (
        <>
          ...
          <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', background: '#13131a', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '24px', padding: '36px', zIndex: 50, width: '440px', boxShadow: '0 20px 40px rgba(0,0,0,0.8)' }}>
            ...
            <ErrorBanner error={createError} onDismiss={() => setCreateError('')} />
